		...
		<tbody>
			<c:forEach items="${data.content }" var="category">
				<tr>
					...
					<td><a
						href="/IT16304.ASM/admin/categories/delete/${category.id }">Delete</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
	...
	<div>
		<ul class="pagination">
			<li class="page-item"><a class="page-link"
				href="/IT16304.ASM/admin/categories/index"> First page </a></li>
			<li class="page-item"><a class="page-link"
				href="/IT16304.ASM/admin/categories/index?page=${ data.number - 1 }">
					Previos page </a></li>
			<li class="page-item"><a class="page-link"
				href="/IT16304.ASM/admin/categories/index?page=${ data.number + 1 }">
					Next page </a></li>
